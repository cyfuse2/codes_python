...
def loc():
    ...
    def ok():
        alert1.destroy()
    b_alert=tk.Button(alert1,text="OK",font=("Arial",15))
    b_alert.pack()
root=tk.Tk()
root.title("Convite")
...
b_ad=tk.Button(root,text="Adicionar",font=("Arial",15))
b_ad.grid(row=4,column=0)
b_exibir=tk.Button(root,text="Exibir",font=("Arial",15))
b_exibir.grid(row=4,column=1)
b_limpar=tk.Button(root,text="Limpar",font=("Arial",15))
b_limpar.grid(row=4,column=2)
label_loc=tk.Button(root,text="Localizar convidado:",font=("Arial",15))
label_loc.grid(row=6,column=0)
b_loc=tk.Button(root,text="Localizar",font=("Arial",15))
